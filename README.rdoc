...
- :preserve_order
  - default: false
  - When set to true, the order of keys in hashes will be the natural hash order rather than sorted alphabetically or explicitelly (useful for syck/psych roundtrip and ruby >= 1.9.2)
...
- :always_emit_quoted_strings
  - default: false
  - When set to true, Ya2YAML will emit string hash values surrounded by quotes. Useful to keep linguistic YAML files consistent.
